  ...
  setInterval(async () => {
      ...
      try {
          for (let i = 1; i <= 6; i++) {
              ...
              else if (price <= 10000) randomValue = random(-500, 500);
              else if (price <= 50000) randomValue = random(-1500, 1500);
              else if (price <= 100000) randomValue = random(-3500, 3500);
              else if (price < 100000) randomValue = random(-7500, 7500);
              else randomValue = random(-15000, 15000);
